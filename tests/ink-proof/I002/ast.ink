...
// CHECK-NEXT:    |--ContentStmt <line:36, col:1:33>
// CHECK-NEXT:    |  `--ContentExpr <col:1, col:32>
// CHECK-NEXT:    |     `--StringLiteral `"What's that?" my master asked.` <col:1, col:32>
// CHECK-NEXT:    `--ChoiceStmt <line:37, line:42>
// CHECK-NEXT:       |--ChoiceStarStmt <line:37, col:1:42>
...
// CHECK-NEXT:       |  `--BlockStmt <line:38, line:39>
// CHECK-NEXT:       |     `--ContentStmt <line:38, col:3:46>
// CHECK-NEXT:       |        `--ContentExpr <col:3, col:45>
// CHECK-NEXT:       |           `--StringLiteral `"Really," he responded. "How deleterious."` <col:3, col:45>
// CHECK-NEXT:       |--ChoiceStarStmt <line:39, col:1:37>
...
// CHECK-NEXT:       |  `--BlockStmt <line:40, line:41>
// CHECK-NEXT:       |     `--ContentStmt <line:40, col:3:22>
// CHECK-NEXT:       |        `--ContentExpr <col:3, col:21>
// CHECK-NEXT:       |           `--StringLiteral `"Very good, then."` <col:3, col:21>
// CHECK-NEXT:       `--ChoiceStarStmt <line:41, col:1:69>
...
// CHECK-NEXT:                `--ContentExpr <col:3, col:101>
